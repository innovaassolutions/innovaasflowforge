export default function DashboardConsulting() {
  return (
    ...
    >
      ...
      <rect x="550" y="65" width="220" height="35" rx="17.5" fill="url(#dashGradConsulting)" />
      ...
      <text x="250" y="125" fontSize="11" fill="#71706B">Active Campaigns</text>
      <text x="250" y="145" fontSize="20" fontWeight="bold" fill="#F25C05">4</text>
      ...
      <text x="425" y="125" fontSize="11" fill="#71706B">Stakeholders Interviewed</text>
      <text x="425" y="145" fontSize="20" fontWeight="bold" fill="#1D9BA3">38</text>
      ...
      <text x="600" y="125" fontSize="11" fill="#71706B">Reports Delivered</text>
      <text x="600" y="145" fontSize="20" fontWeight="bold" fill="#22c55e">7</text>
      ...
      <text x="250" y="205" fontSize="16" fontWeight="bold" fill="#171614">
        Digital Readiness Assessment - Acme Corp
      </text>
      ...
      <text x="250" y="345" fontSize="16" fontWeight="bold" fill="#171614">
        Technology Stack Review - Smith &amp; Co
      </text>
      <text x="250" y="370" fontSize="13" fill="#F25C05" fontWeight="500">
        Planning
      </text>
      <text x="310" y="370" fontSize="13" fill="#71706B">
        8 stakeholders
      </text>
      <rect x="250" y="385" width="400" height="8" rx="4" fill="#E7E5E4" />
      <rect x="250" y="385" width="100" height="8" rx="4" fill="#F25C05" />
      ...
      <text x="250" y="485" fontSize="16" fontWeight="bold" fill="#171614">
        Process Optimization Audit - Global Finance Ltd
      </text>
