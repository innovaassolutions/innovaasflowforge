...
export default function IndustryHeroPharma() {
  return (
    ...
    >
      ...
      <text x="140" y="145" fontSize="12" fill="#71706B">FDA 21 CFR Part 11 • 28 Stakeholders</text>

      {/* Compliance gauge */}
      <rect x="60" y="180" width="340" height="90" rx="12" fill="#FAF8F3" />
      <text x="80" y="205" fontSize="11" fontWeight="600" fill="#71706B">GxP COMPLIANCE SCORE</text>
      ...
      <text x="80" y="255" fontSize="10" fill="#71706B">15% gaps identified across 6 departments</text>

      {/* Compliance checklist */}
      <g transform="translate(60, 290)">
        <text x="0" y="0" fontSize="11" fontWeight="600" fill="#71706B">COMPLIANCE AREAS</text>
        ...
        <text x="38" y="42" fontSize="9" fill="#71706B">ALCOA+ compliant</text>
        ...
        <text x="208" y="42" fontSize="9" fill="#71706B">Version controlled</text>
        ...
        <text x="38" y="87" fontSize="9" fill="#71706B">3 gaps found</text>
        ...
        <text x="208" y="87" fontSize="9" fill="#71706B">Critical findings</text>
      </g>
      ...
      <g transform="translate(510, 100)">
        ...
        <text x="50" y="44" fontSize="8" fill="#71706B" textAnchor="middle">8 interviews</text>
        ...
        <text x="120" y="57" fontSize="8" fill="#71706B" textAnchor="middle">6 interviews</text>
        ...
        <text x="185" y="44" fontSize="8" fill="#71706B" textAnchor="middle">10 interviews</text>
        ...
        <text x="255" y="57" fontSize="8" fill="#71706B" textAnchor="middle">4 interviews</text>
      </g>

      {/* Regulatory findings */}
      <rect x="510" y="185" width="320" height="120" rx="8" fill="#FAF8F3" />
      ...
      <text x="565" y="250" fontSize="9" fill="#71706B">QA department - immediate remediation</text>
      ...
      <text x="565" y="288" fontSize="9" fill="#71706B">Lab systems - 30 day remediation</text>
      ...
      <g transform="translate(510, 345)">
        ...
        <text x="0" y="60" fontSize="8" fill="#71706B" textAnchor="middle">Training</text>

        <circle cx="100" cy="22" r="8" fill="#14B8A6" />
        <text x="100" y="50" fontSize="9" fill="#171614" textAnchor="middle">Week 4</text>
        <text x="100" y="60" fontSize="8" fill="#71706B" textAnchor="middle">Audit Trail</text>
        ...
        <text x="200" y="60" fontSize="8" fill="#71706B" textAnchor="middle">Validation</text>

        <circle cx="320" cy="22" r="8" fill="#E7E5E4" />
        <text x="320" y="50" fontSize="9" fill="#171614" textAnchor="middle">Week 12</text>
        <text x="320" y="60" fontSize="8" fill="#71706B" textAnchor="middle">Audit Ready</text>
      </g>
