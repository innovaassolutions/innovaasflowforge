export default function DashboardEducation() {
  return (
    ...
    >
      ...
      <rect x="550" y="65" width="220" height="35" rx="17.5" fill="url(#dashGradEducation)" />
      ...
      <text x="250" y="125" fontSize="11" fill="#71706B">Parent Responses</text>
      <text x="250" y="145" fontSize="20" fontWeight="bold" fill="#F25C05">214</text>
      ...
      <text x="425" y="125" fontSize="11" fill="#71706B">Faculty Interviewed</text>
      <text x="425" y="145" fontSize="20" fontWeight="bold" fill="#1D9BA3">32</text>
      ...
      <text x="600" y="125" fontSize="11" fill="#71706B">Departments Assessed</text>
      <text x="600" y="145" fontSize="20" fontWeight="bold" fill="#22c55e">8</text>
      ...
      <text x="250" y="485" fontSize="16" fontWeight="bold" fill="#171614">
        Staff Well-Being Assessment 2025
      </text>
