export default function HeroBackground() {
  return (
    ...
    >
      {/* Background gradient shapes - Pearl Vibrant light theme */}
      <defs>
        <radialGradient id="heroGlow1" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#F25C05" stopOpacity="0.4" />
          <stop offset="100%" stopColor="#F25C05" stopOpacity="0" />
        </radialGradient>
        <radialGradient id="heroGlow2" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#1D9BA3" stopOpacity="0.4" />
      ...
      <g transform="translate(750, 300)">
        ...
        <rect x="130" y="90" width="180" height="100" rx="2" fill="#FFFFFF" opacity="0.9" />
        ...
        <rect x="210" y="215" width="20" height="50" fill="#E7E5E4" opacity="0.8" />
        ...
        {/* Mouse */}
        <ellipse cx="320" cy="235" rx="12" ry="18" fill="#E7E5E4" opacity="0.5" />
      </g>

      {/* Floating UI elements - data visualizations */}
      <g opacity="0.3">
        {/* Chart 1 - Bar chart */}
        <rect x="100" y="500" width="150" height="120" rx="8" fill="#E7E5E4" opacity="0.4" />
        <rect x="115" y="580" width="15" height="25" fill="#F25C05" />
        ...
        <path d="M 1050 150 L 1050 90 A 60 60 0 0 1 1095 180 Z" fill="#F25C05" />
        <path d="M 1050 150 L 1095 180 A 60 60 0 0 1 1020 195 Z" fill="#1D9BA3" />
        <path d="M 1050 150 L 1020 195 A 60 60 0 0 1 1050 90 Z" fill="#22c55e" />
