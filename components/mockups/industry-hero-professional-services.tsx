...
export default function IndustryHeroProfessionalServices() {
  return (
    ...
    >
      ...
      <text x="140" y="145" fontSize="12" fill="#78716C">Partner Alignment • 45 Professionals</text>

      {/* Alignment score */}
      <rect x="60" y="175" width="340" height="85" rx="12" fill="#8B5CF6" fillOpacity="0.05" />
      <text x="80" y="200" fontSize="11" fontWeight="600" fill="#78716C">PARTNER STRATEGIC ALIGNMENT</text>
      ...
      <g transform="translate(80, 215)">
        ...
        <text x="180" y="35" fontSize="10" fill="#78716C">Alignment Score</text>
        <text x="260" y="25" fontSize="12" fill="#22C55E">+12% vs last year</text>
      </g>

      {/* Strategic priorities */}
      <text x="60" y="285" fontSize="11" fontWeight="600" fill="#78716C">PARTNER PRIORITY CONSENSUS</text>
      ...
      <text x="105" y="455" fontSize="10" fill="#78716C">Partners split 55/45 on M&A strategy</text>
      ...
      <g transform="translate(510, 95)">
        <text x="0" y="0" fontSize="11" fontWeight="600" fill="#78716C">PRACTICE AREA HEALTH</text>
        ...
        <text x="12" y="78" fontSize="9" fill="#78716C">Pipeline +28%</text>
        ...
        <text x="172" y="78" fontSize="9" fill="#78716C">Pipeline +12%</text>
      </g>

      {/* Client insights */}
      <text x="510" y="200" fontSize="11" fontWeight="600" fill="#78716C">CLIENT RELATIONSHIP INSIGHTS</text>
      ...
      <g transform="translate(510, 215)">
        ...
        <text x="42" y="33" fontSize="9" fill="#78716C">Multiple partners flagged service concerns</text>
        ...
        <text x="42" y="88" fontSize="9" fill="#78716C">Advisory team identified M&A needs</text>
      </g>
      ...
      <g transform="translate(510, 345)">
        <rect x="0" y="0" width="320" height="50" rx="8" fill="#F5F5F4" />
        ...
        <g transform="translate(12, 32)">
          ...
          <text x="65" y="12" fontSize="9" fill="#78716C">3 partners retiring in 18 months</text>
        </g>
      </g>
      ...
      <text x="530" y="448" fontSize="10" fill="#78716C">8 strategic recommendations • 3 urgent client actions</text>
    </svg>
  )
}
