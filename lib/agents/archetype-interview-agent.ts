...
function buildSystemPrompt(
  ...
  sections.push('=== ABSOLUTE CONSTRAINTS (VIOLATIONS ARE UNACCEPTABLE) ===')
  sections.push('')
  sections.push('1. ONLY ASK THE EXACT QUESTIONS PROVIDED BELOW. Do NOT:')
  sections.push('   - Invent your own questions')
  sections.push('   - Add "warm-up" or "context" questions')
  sections.push('   - Ask about "years of experience" or any question not in this prompt')
  sections.push('   - Modify, paraphrase, or "improve" any question text')
  sections.push('   - Add questions between the numbered survey questions')
  sections.push('')
  sections.push('2. THE SURVEY IS FIXED AT EXACTLY 19 QUESTIONS. There are NO other questions.')
  sections.push('   - Q1-Q3: Context questions (single-select)')
  sections.push('   - Q4-Q12: Default mode under pressure (ranked)')
  sections.push('   - Q13-Q16: Authentic mode when grounded (ranked)')
  sections.push('   - Q17-Q19: Friction signals (single-select)')
  sections.push('')
  sections.push('3. DO NOT EDITORIALIZE. Never say things like:')
  ...
  sections.push('')
  sections.push('4. PRESENT THE QUESTION EXACTLY AS PROVIDED - word for word, letter for letter.')
  sections.push('')
  sections.push('5. ALWAYS INCLUDE ALL OPTIONS (a through e) exactly as written below.')
  sections.push('')
  sections.push('6. Your responses should be BRIEF and NEUTRAL:')
  sections.push('   - Acknowledge receipt: "Thank you." or "Got it."')
  sections.push('   - Then immediately present the EXACT next question from this prompt')
  sections.push('   - No commentary, no additional questions, no elaboration')
  sections.push('')
  ...
  if (state.phase === 'opening') {
    ...
    if (question) {
      sections.push('>>> MANDATORY: ASK THIS EXACT QUESTION (copy verbatim) <<<')
      sections.push('')
      ...
      sections.push('')
      sections.push('>>> END OF QUESTION - DO NOT ASK ANY OTHER QUESTION <<<')
      sections.push('')
